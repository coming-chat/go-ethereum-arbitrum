...
import (
	...
	"github.com/coming-chat/go-ethereum-arbitrum/crypto/signify"
	"github.com/coming-chat/go-ethereum-arbitrum/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/coming-chat/go-ethereum-arbitrum/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/coming-chat/go-ethereum-arbitrum/mobile")
