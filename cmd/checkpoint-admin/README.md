...
```shell
go get github.com/coming-chat/go-ethereum-arbitrum/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/coming-chat/go-ethereum-arbitrum/blob/master/params/config.go#L251).*
